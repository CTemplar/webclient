  ...
  function o(t, e) {
    ...
    try {
      for (
        ...
        !(n = (i = f.next()).done) && (r.push(i.value), !e || r.length !== e);
        n = !0
      );
    } catch (t) {
      (a = !0), (o = t);
  ...
  function u(t, e) {
    return new Promise(function (r, n) {
      if ((void 0 === t && n('Target element is undefined'), 'true' !== t.getAttribute('data-scramble-active'))) {
        ...
        h(e.text)
          ? (a = x(e.text))
          : t.getAttribute('data-scramble-text') &&
            '' !== t.getAttribute('data-scramble-text') &&
            (a = x(t.getAttribute('data-scramble-text'))),
          a && ((b = !0), (u = a.truth), (d = a.newLetters), (c = a.startText));
        var v = function () {
          if (
            (c.map(function (e, r) {
              return (
                !(' \t\n\r\v'.indexOf(e) > -1) &&
                ((d[r] = g()), !0 === i[r] && (d[r] = u[r]), (t.textContent = d.join('')), !0)
              );
            }),
            y(d, u))
          ) {
            ...
            clearInterval(m),
              t.setAttribute('data-scramble-active', 'false'),
              t.classList.remove('scrambling'),
              e.afterEach && e.afterEach(t),
              r(t);
          }
        };
        !(function (t) {
  ...
  var l = function (t) {
    ...
    A = function (e, r, n) {
      ...
      if (a && s(r) && r.length > 1) {
        var i = t(r, 2),
          f = i[0],
          u = i[1];
        if (((n >= u || o >= u) && (o = u - 1), (u -= o), f > u && (f = u), v(f) && v(u)))
          return Math.floor(Math.random() * (u - f)) + f;
      }
    ...
    p = function (t, e) {
      ...
      return (
        t &&
          r &&
          ((n.target = void 0 !== t.target ? t.target : '[data-scrambler]'),
          (n.random = void 0 !== t.random ? t.random : [1e3, 3e3]),
          (n.speed = void 0 !== t.speed ? t.speed : 100),
          (n.text = void 0 !== t.text && t.text),
          (n.beforeEach = !(void 0 === t.beforeEach || !b(t.beforeEach)) && t.beforeEach),
          (n.afterEach = !(void 0 === t.afterEach || !b(t.afterEach)) && t.afterEach),
          (n.beforeAll = !(void 0 === t.beforeAll || !b(t.beforeAll)) && t.beforeAll),
          (n.afterAll = !(void 0 === t.afterAll || !b(t.afterAll)) && t.afterAll),
          (n.errorHandler = !(void 0 === t.errorHandler || !b(t.errorHandler)) && t.errorHandler)),
        n
      );
    },
    y = function (t, e) {
