    ...
    function ngxZendeskWebwidgetService(_ngxZendeskWebwidgetConfig) {
        ...
        window.zEmbed || function (e, t) {
            ...
            o.open()._l = function () {
                ...
                n && (this.domain = n), e.id = "js-iframe-async", e.src = "./main.js", this.t = +new Date, this.zendeskHost = _ngxZendeskWebwidgetConfig.accountUrl, this.zEQueue = a, this.body.appendChild(e);
